                        ...
                        <div class="product-image-wrapper" style="height: 400px">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    ...
                                    <a  style="margin-top:-10px;margin-bottom:10px " href="{{URL::to('/product-details/'.$same_pro->pro_id)}}" class="btn btn-default add-to-cart"><i class="fa fa-eye"></i>Xem chi tiết</a>
                                    <h4 style="overflow: hidden; height:40px;">{{$same_pro->name}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
